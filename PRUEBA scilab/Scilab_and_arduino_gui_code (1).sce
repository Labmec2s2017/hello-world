...
'figure_name','Arduino and scilab. Measuring the temperature of a room'); // Gui window
...
'SliderStep',[0.01,0.1],'String','Start measuring temperature','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag', ...
...
'SliderStep',[0.01,0.1],'String','Stop measuring temperature','Style','pushbutton','Value',[0],'VerticalAlignment','middle','Visible','on','Tag', ...
...
Serial_communication = openserial("/dev/ttyACM0","9600,n,8,1") // Open usb serial communication using default values.
