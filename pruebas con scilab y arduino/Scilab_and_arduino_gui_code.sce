...
'figure_name','Arduino and scilab. Measuring '); // Gui window
...
Measurment_points =300; // Measurment tha are plotted.
Ymin =-35000; // Y axes minimun.
Ymax =35000; // Y axes maximun.
...
a.axes_bounds = [0.5,0.025,0.50,0.95];              // [0.5,0.025,0.50,0.95]Setting the position of the graph window.
...
Serial_communication = openserial("COM3","115200,n,8,1") // Open usb serial communication using default values.
